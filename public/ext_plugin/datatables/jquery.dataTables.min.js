...
(function (h) {
    ...
    function rb(a) {
        var b = a.oClasses, 
            ...
            e = a.oPreviousSearch, 
            f = a.aanFeatures,
            g = '<input  type="search" class="' + b.sFilterInput + ' form-control form-control-lg"/>',
            j = d.sSearch, 
            j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g, 
            b = h("<div/>", {
            id: !f.f ? c + "_filter" : null,
            "class": b.sFilter
        }).append(h("<label style='padding-top: 0;display: block' class='form-material'/>").append(j)), f = function () {
            var b = !this.value ?
                "" : this.value;
            b != e.sSearch && (ga(a, {
                sSearch: b,
